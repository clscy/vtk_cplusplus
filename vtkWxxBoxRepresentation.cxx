/*=========================================================================
  ...
  Module:    vtkWxxBoxRepresentation.cxx
...
vtkStandardNewMacro(vtkWxxBoxRepresentation);

//------------------------------------------------------------------------------
vtkWxxBoxRepresentation::vtkWxxBoxRepresentation()
{
  // The initial state
  this->InteractionState = vtkWxxBoxRepresentation::Outside;
  ...
  this->OnePointGeo = vtkSphereSource::New();
  this->OnePointGeo->SetOutputPointsPrecision(vtkAlgorithm::DOUBLE_PRECISION);
  this->OnePointGeo->SetThetaResolution(32);
  this->OnePointGeo->SetPhiResolution(16);
  this->OnePointGeo->SetCenter(this->Points->GetPoint(0));
  this->OnePointGeo->SetRadius(0.1);
  this->OnePointGeo->Update();
  this->OnePointMapper = vtkPolyDataMapper::New();
  this->OnePointMapper->SetInputConnection(this->OnePointGeo->GetOutputPort());
  this->OnePointMapper->Update();
  this->OnePointActor = vtkActor::New();
  this->OnePointActor->SetMapper(this->OnePointMapper);
  this->OnePointActor->SetProperty(this->OnePointProperty);
  ///debug
...
vtkWxxBoxRepresentation::~vtkWxxBoxRepresentation()
{
  ...
  this->OnePointGeo->Delete();
  this->OnePointMapper->Delete();
  this->OnePointProperty->Delete();
  this->OnePointActor->Delete();
  ///debug
}

//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::GetPolyData(vtkPolyData* pd)
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::StartWidgetInteraction(double e[2])
{
...
void vtkWxxBoxRepresentation::SetTwoPlaneMode(bool val)
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::WidgetInteraction(double e[2])
{
  ...
  // Process the motion
  if (this->InteractionState == vtkWxxBoxRepresentation::MoveF0)
  {
    this->MoveMinusXFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::MoveF1)
  {
    this->MovePlusXFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::MoveF2)
  {
    this->MoveMinusYFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::MoveF3)
  {
    this->MovePlusYFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::MoveF4)
  {
    this->MoveMinusZFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::MoveF5)
  {
    this->MovePlusZFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::Translating)
  {
    // 按住shift或ctrl键后, 鼠标左击实现
    this->Translate(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::Scaling)
  {
    // 选中一个面, 鼠标右击实现
    this->Scale(prevPickPoint, pickPoint, static_cast<int>(e[0]), static_cast<int>(e[1]));
  }

  else if (this->InteractionState == vtkWxxBoxRepresentation::Rotating)
  {
    //选中一个面, 鼠标左击实现
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MoveFace(const double* p1, const double* p2, const double* dir,
  double* x1, double* x2, double* x3, double* x4, double* x5)
{
  ...
  ///debug
  double* pts1 = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double focalPoint[4];
  vtkInteractorObserver::ComputeWorldToDisplay(this->Renderer, pts1[0], pts1[1], pts1[2], focalPoint);
  this->textActor->SetDisplayPosition(static_cast<int>(focalPoint[0]), static_cast<int>(focalPoint[1]));
  const std::string& new_val0 = std::to_string(static_cast<int>(focalPoint[0]));
  const std::string& new_val1 = std::to_string(static_cast<int>(focalPoint[1]));
  std::string new_val = "(" + new_val0 + ", " + new_val1 + ")";
  this->textActor->SetInput(new_val.c_str());
  ///debug
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::GetDirection(
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MovePlusXFace(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MoveMinusXFace(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MovePlusYFace(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MoveMinusYFace(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MovePlusZFace(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::MoveMinusZFace(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
void vtkWxxBoxRepresentation::Translate(const double* p1, const double* p2)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double v[3] = { 0, 0, 0 };
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::Scale(
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::ComputeNormals()
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double* p0 = pts;
  double* px = pts + 3 * 1;
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::GetPlanes(vtkPlanes* planes)
{
  if (!planes)
  {
    return;
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::Rotate(
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::CreateDefaultProperties()
{
  // Handle properties
  ...
  this->FaceProperty->SetOpacity(0.5);

  this->SelectedFaceProperty = vtkProperty::New();
  this->SelectedFaceProperty->SetColor(1, 0, 0);
  this->SelectedFaceProperty->SetOpacity(1);
  ...
  this->SelectedOutlineProperty->SetAmbientColor(0.0, 0.0, 0.0);
  this->SelectedOutlineProperty->SetLineWidth(2.0);

  ///debug
  this->textProperty = vtkTextProperty::New();
  this->textProperty->SetColor(1, 0, 0);
  this->textProperty->SetFontFamilyToArial();
  this->textProperty->BoldOn();
  this->textProperty->SetFontSize(20);

  OnePointProperty = vtkProperty::New();
  this->OnePointProperty->SetColor(1, 0, 0);
  ///debug
}

//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::PlaceWidget(double bds[6])
{
  int i;
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::GetTransform(vtkTransform* t)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double* p0 = pts;
  double* p1 = pts + 3 * 1;
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::SetTransform(vtkTransform* t)
{
  if (!t)
  {
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::SetOutlineFaceWires(int newValue)
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::SetOutlineCursorWires(int newValue)
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::GenerateOutline()
{
...
//------------------------------------------------------------------------------
int vtkWxxBoxRepresentation::ComputeInteractionState(int X, int Y, int modify)
{
  ...
  if (path != nullptr)
  {
    ...
    {
      this->InteractionState = vtkWxxBoxRepresentation::MoveF0;
    }
    else if (this->CurrentHandle == this->Handle[1])
    {
      this->InteractionState = vtkWxxBoxRepresentation::MoveF1;
    }
    else if (this->CurrentHandle == this->Handle[2])
    {
      this->InteractionState = vtkWxxBoxRepresentation::MoveF2;
    }
    else if (this->CurrentHandle == this->Handle[3])
    {
      this->InteractionState = vtkWxxBoxRepresentation::MoveF3;
    }
    else if (this->CurrentHandle == this->Handle[4])
    {
      this->InteractionState = vtkWxxBoxRepresentation::MoveF4;
    }
    else if (this->CurrentHandle == this->Handle[5])
    {
      this->InteractionState = vtkWxxBoxRepresentation::MoveF5;
    }
    else if (this->CurrentHandle == this->Handle[6])
    {
      this->InteractionState = vtkWxxBoxRepresentation::Translating;
    }
  }
  else // see if the hex is picked
  {
    ...
    if (path != nullptr)
    {
      ...
      if (!modify)
      {
        this->InteractionState = vtkWxxBoxRepresentation::Rotating;
      }
      else
      {
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::SetInteractionState(int state)
{
  // Clamp to allowable values
  state = (state < vtkWxxBoxRepresentation::Outside
      ? vtkWxxBoxRepresentation::Outside
      : (state > vtkWxxBoxRepresentation::Scaling ? vtkWxxBoxRepresentation::Scaling : state));
  ...
  switch (state)
  {
    case vtkWxxBoxRepresentation::MoveF0:
    case vtkWxxBoxRepresentation::MoveF1:
    case vtkWxxBoxRepresentation::MoveF2:
    case vtkWxxBoxRepresentation::MoveF3:
    case vtkWxxBoxRepresentation::MoveF4:
    case vtkWxxBoxRepresentation::MoveF5:
      this->HighlightOutline(0);
      handle = this->HighlightHandle(this->CurrentHandle);
      this->HighlightFace(handle);
      break;
    case vtkWxxBoxRepresentation::Rotating:
      this->HighlightOutline(0);
      this->HighlightHandle(nullptr);
      this->HighlightFace(this->HexPicker->GetCellId());
      break;
    case vtkWxxBoxRepresentation::Translating:
    case vtkWxxBoxRepresentation::Scaling:
...
//------------------------------------------------------------------------------
double* vtkWxxBoxRepresentation::GetBounds()
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::BuildRepresentation()
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::ReleaseGraphicsResources(vtkWindow* w)
{
  ...
  this->OnePointActor->ReleaseGraphicsResources(w);
  ///debug
  // render the handles
  for (int j = 0; j < 7; j++)
  {
...
//------------------------------------------------------------------------------
int vtkWxxBoxRepresentation::RenderOpaqueGeometry(vtkViewport* v)
{
  int count = 0;
  this->BuildRepresentation();
  ...
  this->OnePointActor->SetPropertyKeys(this->GetPropertyKeys());
  ///debug
  ...
  count += this->OnePointActor->RenderOpaqueGeometry(v);
  ///debug
  for (int j = 0; j < 7; j++)
  {
...
//------------------------------------------------------------------------------
int vtkWxxBoxRepresentation::RenderTranslucentPolygonalGeometry(vtkViewport* v)
{
  int count = 0;
  this->BuildRepresentation();
  ...
  count += this->OnePointActor->RenderTranslucentPolygonalGeometry(v);
  ///debug
...
//------------------------------------------------------------------------------
vtkTypeBool vtkWxxBoxRepresentation::HasTranslucentPolygonalGeometry()
{
  // int result = 0;
  // this->BuildRepresentation();
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::PositionHandles()
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double* p0 = pts;
  double* p1 = pts + 3 * 1;
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::HandlesOn()
{
  if (this->TwoPlaneMode)
  {
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::HandlesOff()
{
  for (int i = 0; i < 7; i++)
  {
    this->Handle[i]->VisibilityOff();
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::SizeHandles()
{
  double* center = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(3 * 14);
...
//------------------------------------------------------------------------------
int vtkWxxBoxRepresentation::HighlightHandle(vtkProp* prop)
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::HighlightFace(int cellId)
{
  if (cellId >= 0)
  {
    vtkIdType npts;
    ...
    ///debug
    // this->atext->SetText("cls");
    // this->textActor->AddPosition(pts1[0], pts1[1], pts1[2]);
    ///debug
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::HighlightOutline(int highlight)
{
  if (highlight)
  {
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::RegisterPickers()
{
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::GetActors(vtkPropCollection* pc)
{
  if (!pc)
  {
    return;
...
//------------------------------------------------------------------------------
void vtkWxxBoxRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
