...
=========================================================================*/
/**
 * @class   vtkWxxBoxWidget2
 * @brief   3D widget for manipulating a box
 *
 * This 3D widget interacts with a vtkWxxBoxRepresentation class (i.e., it
 ...
 * object rotation or scaling. A nice feature of vtkWxxBoxWidget2, like any 3D
 * widget, will work with the current interactor style. That is, if
 * vtkWxxBoxWidget2 does not handle an event, then all other registered
 * observers (including the interactor style) have an opportunity to process
 * the event. Otherwise, the vtkBoxWidget will terminate the processing of
 * the event that it handles.
 *
 * To use this widget, you generally pair it with a vtkWxxBoxRepresentation
 ...
 * into the vtkWxxBoxWidget2's widget events:
 * <pre>
 ...
 *
 * @par Event Bindings:
 * In turn, when these widget events are processed, the vtkWxxBoxWidget2
 ...
 *
 * @par Event Bindings:
 * This class, and the affiliated vtkWxxBoxRepresentation, are second generation
 * VTK widgets. An earlier version of this functionality was defined in the
 * class vtkBoxWidget.
 *
 * @sa
 * vtkWxxBoxRepresentation vtkBoxWidget
 */

#ifndef vtkWxxBoxWidget2_h
#define vtkWxxBoxWidget2_h

#include "vtkAbstractWidget.h"
#include "vtkDeprecation.h"              // For VTK_DEPRECATED_IN_9_2_0
#include "vtkInteractionWidgetsModule.h" // For export macro

class vtkWxxBoxRepresentation;
class vtkHandleWidget;

class VTKINTERACTIONWIDGETS_EXPORT vtkWxxBoxWidget2 : public vtkAbstractWidget
{
public:
  /**
   * Instantiate the object.
   */
  static vtkWxxBoxWidget2* New();

  ///@{
  /**
   * Standard class methods for type information and printing.
   */
  vtkTypeMacro(vtkWxxBoxWidget2, vtkAbstractWidget);
   ...
   */
  void SetRepresentation(vtkWxxBoxRepresentation* r)
  {
   ...
   * this is an instance of the vtkWxxBoxRepresentation class.
   */
...
private:
  vtkWxxBoxWidget2(const vtkWxxBoxWidget2&) = delete;
  void operator=(const vtkWxxBoxWidget2&) = delete;
};
