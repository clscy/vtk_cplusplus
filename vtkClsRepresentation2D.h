/*=========================================================================
  ...
  Module:    vtkClsRepresentation2D.h
...
#ifndef vtkClsRepresentation2D_h
#define vtkClsRepresentation2D_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkClsRepresentation2D : public vtkAffineRepresentation
{
public:
  /**
   * Instantiate this class.
   */
  static vtkClsRepresentation2D* New();

  ///@{
  /**
   * Standard methods for instances of this class.
   */
  vtkTypeMacro(vtkClsRepresentation2D, vtkAffineRepresentation);
  ...
  ///@{
  /**
   * Subclasses of vtkClsRepresentation2D must implement these methods. These
...
protected:
  vtkClsRepresentation2D();
  ~vtkClsRepresentation2D() override;
...
private:
  vtkClsRepresentation2D(const vtkClsRepresentation2D&) = delete;
  void operator=(const vtkClsRepresentation2D&) = delete;
};
