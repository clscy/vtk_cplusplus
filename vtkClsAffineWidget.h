...
=========================================================================*/
/**
 * @class   vtkClsAffineWidget
 * @brief   perform affine transformations
 *
 * The vtkClsAffineWidget is used to perform affine transformations on objects.
 ...
 * into the vtkClsAffineWidget's widget events:
 * <pre>
 ...
 *
 * @par Event Bindings:
 * In turn, when these widget events are processed, the vtkClsAffineWidget
...
#ifndef vtkClsAffineWidget_h
#define vtkClsAffineWidget_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkClsAffineWidget : public vtkAbstractWidget
{
public:
  /**
   * Instantiate this class.
   */
  static vtkClsAffineWidget* New();

  ///@{
  /**
   * Standard VTK class macros.
   */
  vtkTypeMacro(vtkClsAffineWidget, vtkAbstractWidget);
...
private:
  vtkClsAffineWidget(const vtkClsAffineWidget&) = delete;
  void operator=(const vtkClsAffineWidget&) = delete;
};
