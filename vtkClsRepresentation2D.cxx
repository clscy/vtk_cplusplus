/*=========================================================================
  ...
  Module:    vtkClsRepresentation2D.cxx
...
vtkStandardNewMacro(vtkClsRepresentation2D);

vtkCxxSetObjectMacro(vtkClsRepresentation2D, Property, vtkProperty2D);
vtkCxxSetObjectMacro(vtkClsRepresentation2D, SelectedProperty, vtkProperty2D);
vtkCxxSetObjectMacro(vtkClsRepresentation2D, TextProperty, vtkTextProperty);

#define VTK_CIRCLE_RESOLUTION 64

//------------------------------------------------------------------------------
vtkClsRepresentation2D::vtkClsRepresentation2D()
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::GetTransform(vtkTransform* t)
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::PlaceWidget(double bounds[6])
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::SetOrigin(double ox, double oy, double oz)
{
...
//------------------------------------------------------------------------------
int vtkClsRepresentation2D::ComputeInteractionState(int X, int Y, int modify)
{
...
void vtkClsRepresentation2D::StartWidgetInteraction(double startEventPos[2])
{
...
// of the widget.
void vtkClsRepresentation2D::WidgetInteraction(double eventPos[2])
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::EndWidgetInteraction(double vtkNotUsed(eventPos)[2])
{
...
void vtkClsRepresentation2D::Translate(double eventPos[2])
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::Scale(double eventPos[2])
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::Rotate(double eventPos[2])
{
  double deltaAngle;
...
void vtkClsRepresentation2D::ApplyShear() {}

//------------------------------------------------------------------------------
void vtkClsRepresentation2D::Shear(double eventPos[2])
{
  // Determine the relative motion
  double d[3];
  d[0] = eventPos[0] - this->StartEventPosition[0];
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::Highlight(int highlight)
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::CreateDefaultProperties()
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::UpdateText(const char* text, double eventPos[2])
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::BuildRepresentation()
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::ShallowCopy(vtkProp* prop)
{
  vtkClsRepresentation2D* rep = vtkClsRepresentation2D::SafeDownCast(prop);
  if (rep)
  {
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::GetActors2D(vtkPropCollection* pc)
{
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::ReleaseGraphicsResources(vtkWindow* win)
{
...
//------------------------------------------------------------------------------
int vtkClsRepresentation2D::RenderOverlay(vtkViewport* viewport)
{
  this->BuildRepresentation();
...
//------------------------------------------------------------------------------
void vtkClsRepresentation2D::PrintSelf(ostream& os, vtkIndent indent)
{
