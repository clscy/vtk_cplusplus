/*=========================================================================
  ...
  Module:    vtkWxxBoxRepresentation.h
...
#ifndef vtkWxxBoxRepresentation_h
#define vtkWxxBoxRepresentation_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkWxxBoxRepresentation : public vtkWidgetRepresentation
{
public:
  /**
   * Instantiate the class.
   */
  static vtkWxxBoxRepresentation* New();

  ///@{
  /**
   * Standard methods for the class.
   */
  vtkTypeMacro(vtkWxxBoxRepresentation, vtkWidgetRepresentation);
...
protected:
  vtkWxxBoxRepresentation();
  ~vtkWxxBoxRepresentation() override;
  ...
  vtkSphereSource* OnePointGeo;
  vtkPolyDataMapper* OnePointMapper;
  vtkProperty* OnePointProperty;
  vtkActor* OnePointActor;
  ///debug
...
private:
  vtkWxxBoxRepresentation(const vtkWxxBoxRepresentation&) = delete;
  void operator=(const vtkWxxBoxRepresentation&) = delete;
};
